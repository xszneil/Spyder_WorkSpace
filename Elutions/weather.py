...
base_url1 = 'http://api.wunderground.com/api/api-key/history_'
base_url2 = 'http://api.wunderground.com/api/api-key/history_'
base_url3 = 'http://api.wunderground.com/api/api-key/history_'
start_date = datetime.date(2013,06,29);
